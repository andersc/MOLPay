...
/**
 For security reasons, call blackout when application goes background
 */
- (void)blackout;

/**
 For security reasons, call uncover when application goes foreground
 */
- (void)uncover;
...
/**
 ...
 Transaction Info should inc lude this key&value:
 @code
